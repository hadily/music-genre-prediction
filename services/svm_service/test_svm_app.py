...
def test_predict_valid_file(client):
    ...
    with open(audio_file_path, 'rb') as audio_file:
        ...
        assert b"genre" in response.data, "Response does not contain 'genre'"
...
def test_predict_no_file_provided(client):
    ...
    assert b"No file provided" in response.data, "Error message for missing file is incorrect or not present"
